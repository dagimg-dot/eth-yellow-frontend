...
const signupHandler = async () => {
    ...
    if (result.value && result.value.success) {
        toast.success(result.value.message + " You are begin redirected to the login page");
    ...
    <div class="d-flex h-screen align-center justify-center bg-grey-lighten-4">
        <VCard class="auth-card pa-4 pt-7" max-width="448">
            ...
            <VCardText class="pt-2">
                ...
                <p class="mb-0">
                    Reach larger audience with <strong>ethyellow.</strong> Sign up to get started.
                </p>
            </VCardText>
            ...
            <VCardText>
                <VForm @submit.prevent="signupHandler" ref="signupForm">
                    <VRow>
                        <!-- Email -->
                        <VCol cols="12">
                            <VTextField v-model="form.username" autofocus placeholder="jvon" label="Username"
                                :rules="usernameRules" type="text" required />
                        </VCol>

                        <!-- Username -->
                        <VCol cols="12">
                            <VTextField v-model="form.email" placeholder="johndoe@email.com" label="Email"
                        ...
                        <!-- Confirm Password -->
                        <VCol cols="12">
                            <VTextField v-model="form.confirmedPassword" label="Confirm Password"
                                placeholder="············" :type="isConfirmPasswordVisible ? 'text' : 'password'"
                                :append-inner-icon="isConfirmPasswordVisible ? 'bx-hide' : 'bx-show'"
                                @click:append-inner="isConfirmPasswordVisible = !isConfirmPasswordVisible"
                                :rules="confirmedPasswordRules" required />
